  ...
  return (
    ...
    >
      ...
      <header className="flex flex-col items-start gap-2 self-stretch bg-white pl-6 pr-4 py-4 md:h-[357px] md:bg-purple md:rounded-b-3xl">
        <nav
          className="flex items-center gap-4 self-stretch justify-center md:bg-white md:rounded-xl md:justify-between md:pl-6 md:pr-4 md:py-4 "
          aria-labelledby="page-option"
        >
          <h2 className="sr-only" id="page-option">
            Page option
          </h2>
          <Link
      ...
      <section
        aria-labelledby="preview-elements"
